...
(
    ...
    rating                    float        null,
    estimated_visit_duraation int          null
);
...
(
    ...
    constraint fk_route_day_plan
        foreign key (day_plan_id) references day_plan (plan_id)
            on delete cascade,
    constraint fk_route_place
